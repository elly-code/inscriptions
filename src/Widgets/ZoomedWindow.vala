...
*/
 public class Inscriptions.ZoomedWindow : Gtk.Widget {
    ...
    */
    private void do_set_zoom (int new_zoom) {
        ...
        remove_css_class (Inscriptions.ZoomLevel.from_int (_old_zoom).to_css_class ());
        _old_zoom = new_zoom;
        add_css_class (Inscriptions.ZoomLevel.from_int (new_zoom).to_css_class ());
